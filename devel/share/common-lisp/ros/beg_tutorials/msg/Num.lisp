...
(cl:in-package beg_tutorials-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beg_tutorials-msg:<Num> is deprecated: use beg_tutorials-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beg_tutorials-msg:num-val is deprecated.  Use beg_tutorials-msg:num instead.")
  (num m))
